  ...
  return (
    <AuthCard>
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-3 font-disp text-[20px] font-semibold text-text">You&apos;ve been signed out</h1>
        <p className="mt-1.5 text-[13px] text-dim">
          Your session on this device has ended. Active threads keep running on the harness.
        </p>
        <Button className="mt-5" size="lg" block onClick={() => router.replace(ROUTES.auth.login())}>
          Sign back in
        </Button>
      </div>
    </AuthCard>
