...
export function TopBar() {
  ...
  return (
    <header
      ...
      style={{ background: 'color-mix(in srgb, var(--panel) 82%, transparent)', backdropFilter: 'blur(12px)' }}
    >
      <Link href={ROUTES.workspace()} className="flex items-center gap-2.5" aria-label="Atlas home">
        ...
        <span className="font-disp text-[14px] font-bold tracking-[0.16em] text-text">ATLAS</span>
      </Link>
