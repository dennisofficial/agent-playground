 ...
 */
export function SubagentCard({ summary, onOpen }: { summary: SubagentSummary; onOpen: () => void }) {
      ...
      <div className="flex items-center gap-2.5 px-3 py-2.5">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <div className="flex items-center gap-2">
            <span className="truncate text-[12.5px] font-semibold text-text">{subagentLabel(summary.type)}</span>
            {summary.background ? (
