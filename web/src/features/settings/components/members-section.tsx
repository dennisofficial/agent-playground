    ...
    <>
      <div className="flex items-start gap-3.5">
        <div className="flex-1">
          <h1 className="font-disp text-[22px] font-semibold tracking-[-0.01em] text-text">Members</h1>
...
function MemberRow({ member }: { member: Member }) {
  ...
  return (
    <div className="flex items-center px-4 py-3.5" style={{ borderBottom: '1px solid var(--hair)' }}>
