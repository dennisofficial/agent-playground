...
export const qk = {
  ...
  orgGithubAppStatus: (orgId: string) => ['org-github-app-status', orgId] as const,
  ...
  repoFile: (ref: { orgId: string; repoId: string; jobId: string }, path: string) =>
  ...
  orgConventionProfiles: (orgId: string) => ['org-convention-profiles', orgId] as const,
  ...
  orgClaudeCredentials: (orgId: string) => ['org-claude-credentials', orgId] as const,
