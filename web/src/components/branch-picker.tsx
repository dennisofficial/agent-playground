      ...
      {open && pos && typeof document !== 'undefined'
        ? createPortal(
            <div
              ...
              style={{ top: pos.top, left: pos.left, width: pos.width, boxShadow: 'var(--shadow-menu)' }}
            >
    ...
    <Dropdown
      trigger={
        <>
          ...
          <span className="flex-1 truncate text-left font-mono text-[11.5px] text-text">{current}</span>
