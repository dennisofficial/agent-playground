    ...
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative flex max-w-[560px] flex-col items-center px-6 text-center">
        ...
        <div className="anim-fadeUp" style={ILLUSTRATION}>
          ...
          <div className="flex flex-col items-center gap-2.5">
            <div style={NODE_CARD}>
              ...
              <span style={{ ...BAR, background: "var(--border-2)" }} />
              <span
                style={{ ...BAR, background: "var(--accent)", opacity: 0.85 }}
              />
            </div>
        ...
        <div
          ...
          style={{ ...BADGE, animationDelay: "0.06s" }}
        >
        ...
        <h1
          className="anim-fadeUp font-disp"
          style={{ ...HEADLINE, animationDelay: "0.1s" }}
        >
          Can’t reach the server
        </h1>

        <p
          className="anim-fadeUp text-dim"
          style={{ ...BODY, animationDelay: "0.14s" }}
        >
          Atlas lost its connection to the workspace backend. Your work is safe
          — running threads keep going and the board will resync the moment
          we’re back.
        </p>

        {/* error detail */}
        <div
          className="anim-fadeUp font-mono"
          style={{ ...DETAIL, animationDelay: "0.18s" }}
        >
        ...
        <div
          className="anim-fadeUp"
          style={{ marginTop: 26, animationDelay: "0.22s" }}
        >
          <Button
            variant="primary"
            loading={retrying}
        ...
        <div
          className="anim-fadeUp font-mono"
          style={{ ...AUTO_LINE, animationDelay: "0.26s" }}
        >
          {retrying
            ? "attempting to reconnect…"
            : `auto-retry in 0:0${Math.max(secs, 1)}`}
        </div>
      </div>
    </main>
  );
...
const BREAK_MARKER: CSSProperties = {
  ...
  justifyContent: "center",
  boxShadow:
    "0 0 0 5px var(--bg), 0 2px 10px color-mix(in srgb, var(--red) 22%, transparent)",
...
const DETAIL_DIV: CSSProperties = {
  width: 1,
  height: 11,
