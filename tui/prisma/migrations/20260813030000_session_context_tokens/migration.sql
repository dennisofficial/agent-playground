...
CREATE TABLE "new_EngineSession" (
    ...
    CONSTRAINT "EngineSession_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_EngineSession" ("accountId", "createdAt", "endReason", "endedAt", "engine", "engineConfig", "engineSessionId", "handoff", "id", "model", "ordinal", "seededFromId", "threadId") SELECT "accountId", "createdAt", "endReason", "endedAt", "engine", "engineConfig", "engineSessionId", "handoff", "id", "model", "ordinal", "seededFromId", "threadId" FROM "EngineSession";
