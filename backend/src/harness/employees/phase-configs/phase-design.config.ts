...
- You are ONE section of a larger feature, carried across sequential sessions that all share the feature's ONE branch in this workstation. Hand the next section a clear, buildable design intent (committed to this branch) rather than writing production code yourself — read what earlier sections built and design against the real surface, not a guess.`;
  }
}
