...
- You are ONE section of a larger feature, carried across sequential sessions that all share the feature's ONE branch in this workstation. Land your section's slice (copy, pages, GTM plan) cleanly on this branch so the next section builds on real work, not a guess.`;
  }
}
