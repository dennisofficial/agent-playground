...
import type { RepoEntity, ThreadEntity, ThreadSandboxEntity } from '../persistence/entities';
...
/** Build a bare-minimum ThreadSandboxEntity row for testing rowToSandbox. */
...
function makeService(): ThreadLifecycleService {
  ...
  return new ThreadLifecycleService(
    stubRepo() as unknown as Repository<ThreadEntity>,
    stubRepo() as unknown as Repository<ThreadSandboxEntity>,
    stubRepo() as unknown as Repository<RepoEntity>,
...
function rowToSandbox(svc: ThreadLifecycleService, row: ThreadSandboxEntity) {
  return (svc as unknown as { rowToSandbox(r: ThreadSandboxEntity): import('../git').FeatureSandbox })
    .rowToSandbox(row);
}
