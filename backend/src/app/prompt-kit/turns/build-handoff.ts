...
export const HANDOFF_SCHEMA = [
  ...
  '4. Decisions — choices you made this session that are not already written into `.atlas/decisions/`.',
  ...
  '8. Pointers — the durable artifacts to re-read (`/context/specs`, `.atlas/decisions/`, the commit SHA). Reference',
...
export const ROTATION_PREAMBLE = [
  ...
  '`.atlas/decisions/`, `get_pipeline_state`), then continue from its "Next safe action".',
  '</session_rotated>',
].join('\n');
 ...
 */
export const ROTATION_REMINDER_NUDGE = [
  '<context_pressure phase="reminder">',
...
export const RECORD_LEG_HANDOFF_DESCRIPTION =
  ...
  '(`/context/specs`, `.atlas/decisions/`). After calling this, STOP and yield — your WIP is on disk.';
