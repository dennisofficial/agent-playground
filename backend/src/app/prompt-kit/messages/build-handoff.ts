 ...
 */
export const ROTATION_PREAMBLE = renderHarnessTag({
  tag: 'session_rotated',
  body: [
 ...
 */
export const ROTATION_RESUME_TAIL = renderHarnessTag({
  tag: 'resume_here',
  body: [
 ...
 */
export const ROTATION_SOFT_NUDGE = renderHarnessTag({
 ...
 */
export const ROTATION_REMINDER_NUDGE = renderHarnessTag({
  tag: 'context_pressure',
