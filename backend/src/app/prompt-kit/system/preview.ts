...
export const AGENT_PROMPTS: AgentPromptInfo[] = [
  ...
  },
  {
    ...
    ctx: {
      jobKind: 'feature',
      settings: { userOrgInstructions: SAMPLE_ORG_INSTRUCTIONS },
    },
  },
  {
    ...
    ctx: {
      jobKind: 'feature',
      settings: { repoConventions: SAMPLE_REPO_CONVENTIONS },
    },
  },
  {
    ...
    ctx: {
      jobKind: 'feature',
      settings: { workspaceProfile: SAMPLE_WORKSPACE_PROFILE },
    },
  },
  {
  ...
  },
  {
    id: 'worker-bugfix',
    agent: Agent.WORKER,
    note: 'build thread orchestrator — bugfix job kind',
    ctx: { jobKind: 'bugfix' },
  },
  {
    id: 'worker-event',
    agent: Agent.WORKER,
    note: 'build thread orchestrator — event job kind',
    ctx: { jobKind: 'event' },
  },
  {
  ...
  {
    id: 'ship-master-review',
    agent: Agent.MASTER_REVIEW,
    note: 'ship Codex master review',
    ctx: {},
  },
  {
    id: 'autofix-review',
    agent: Agent.AUTOFIX_REVIEW,
    note: 'auto-fix review pass',
    ctx: {},
  },
  {
  ...
  },
  {
    id: 'subagent-explore',
    agent: Agent.EXPLORE,
    note: 'engine explore subagent',
    ctx: {},
  },
  {
    id: 'subagent-docs',
    agent: Agent.DOCS,
    note: 'engine docs subagent',
    ctx: {},
  },
  {
    id: 'subagent-review',
    agent: Agent.REVIEW_AGENT,
    note: 'engine review subagent',
    ctx: {},
  },
  {
  ...
  },
  {
    id: 'subagent-debug',
    agent: Agent.DEBUG,
    note: 'engine debug subagent',
    ctx: {},
  },
  {
    id: 'subagent-test',
    agent: Agent.TEST,
    note: 'engine test subagent',
    ctx: {},
  },
  {
    id: 'subagent-validate',
    agent: Agent.VALIDATE,
    note: 'engine live-validation + evidence subagent',
    ctx: {},
  },
  {
  ...
  },
  {
    ...
    note: 'engine design-fidelity prototype subagent',
    ctx: {},
  },
  {
    id: 'subagent-writer',
    agent: Agent.FAN_OUT,
    note: 'engine implement/implement-deep writer',
    ctx: {},
  },
  {
...
export function listAgentPrompts(): Array<{
  ...
  return AGENT_PROMPTS.map(({ id, agent, note }) => ({
    id,
    agent: String(agent),
    note,
  }));
