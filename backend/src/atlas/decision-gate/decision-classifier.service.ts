...
import { ATLAS_CLASSIFIER_LLM, type ClassifierLlm } from './classifier-llm';
import type {
  ClassifierRecord,
 ...
 *
 *   1. `covered`  — the record already settles this class (the section planner proceeds silently).
...
export class DecisionClassifier {
  ...
  constructor(
    @Inject(ATLAS_CLASSIFIER_LLM) private readonly llm: ClassifierLlm,
  ) {}
