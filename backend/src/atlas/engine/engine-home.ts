 ...
 * `ATLAS_AGENT_HOME_ROOT` (or fall back to v1's `AGENT_HOME_ROOT`) — point it at a persistent volume
...
/** The base under which all Atlas engine homes live — `ATLAS_AGENT_HOME_ROOT` when set, else the
