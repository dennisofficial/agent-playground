/**
 * R0 GATE — AtlasWebSurface unit tests.
 *
 * Proves:
...
describe('AtlasWebSurface — inbound + outbound', () => {
  let surface: AtlasWebSurface;

  beforeEach(() => {
    surface = new AtlasWebSurface();
  });
...
describe('AtlasWebSurface — approval card conversion', () => {
  let surface: AtlasWebSurface;
...
describe('AtlasWebSurface — approval click via approval$', () => {
...
describe('AtlasWebSurface — update()', () => {
...
describe('AtlasWebSurface.channelMessages', () => {
