...
export class HaltOutcome1783597139527 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "uq_threads_job_parent_ordinal" ON "threads" ("job_id", "ordinal", "parent_thread_id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "uq_threads_ticket_id" ON "jobs" ("ticket_id") WHERE (ticket_id IS NOT NULL)`);
        await queryRunner.query(`CREATE INDEX "idx_tickets_embedding_hnsw" ON "tickets" ("embedding") `);
    }
