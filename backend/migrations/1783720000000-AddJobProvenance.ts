...
export class AddJobProvenance1783720000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "jobs" ADD CONSTRAINT "fk_jobs_created_by_job_id_jobs" FOREIGN KEY ("created_by_job_id") REFERENCES "jobs"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_jobs_created_by_job_id" ON "jobs" ("created_by_job_id")`,
    );
  }
