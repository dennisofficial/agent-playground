...
export class SendStateCorrelation1784228313072 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transcript_messages" ADD "delivered_at" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_transcript_messages_stimulus_id" ON "transcript_messages" ("stimulus_id") `,
    );
  }
