...
export class AddSessionResumeClock1783631366055 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "jobs" ADD "session_resume_at" TIMESTAMP WITH TIME ZONE`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "jobs" DROP COLUMN "session_resume_at"`);
  }
}
