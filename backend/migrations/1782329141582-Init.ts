...
export class Init1782329141582 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "organizations" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "slug" text NOT NULL, "status" text NOT NULL DEFAULT 'onboarding', CONSTRAINT "pk_organizations" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_organizations_slug" ON "organizations" ("slug") `,
    );
    await queryRunner.query(
      `CREATE TABLE "organization_members" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "org_id" uuid NOT NULL, "user_id" uuid NOT NULL, "role" text NOT NULL DEFAULT 'member', CONSTRAINT "pk_organization_members" PRIMARY KEY ("org_id", "user_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_org_invites_token" ON "org_invites" ("token") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_threads_org_id_repo_id" ON "threads" ("org_id", "repo_id") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_thread_sandboxes_thread_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_decision_records_org_id_repo_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_decision_records_thread_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_stimuli_org_id_repo_id_source_dedupe_key"`,
    );
