...
export class AddOrgSecrets1784320652497 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."org_secrets_key_enum" AS ENUM('github_pat', 'anthropic_api_key', 'openai_api_key', 'codex_auth')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "org_secrets" DROP CONSTRAINT "fk_org_secrets_org_id_organizations"`);
