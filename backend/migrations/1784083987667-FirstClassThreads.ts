...
export class FirstClassThreads1784083987667 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_stages_decision_record_id" ON "stages" ("decision_record_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "stages" ADD CONSTRAINT "fk_stages_job_id_jobs" FOREIGN KEY ("job_id") REFERENCES "jobs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "stages" ADD CONSTRAINT "fk_stages_org_id_organizations" FOREIGN KEY ("org_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "stages" ADD CONSTRAINT "fk_stages_decision_record_id_decision_records" FOREIGN KEY ("decision_record_id") REFERENCES "decision_records"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "fk_tasks_stage_id_stages" FOREIGN KEY ("stage_id") REFERENCES "stages"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subagents" ADD CONSTRAINT "fk_subagents_parent_message_id_messages" FOREIGN KEY ("parent_message_id") REFERENCES "messages"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_messages_subagent_id" ON "messages" ("subagent_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "messages" ADD CONSTRAINT "fk_messages_subagent_id_subagents" FOREIGN KEY ("subagent_id") REFERENCES "subagents"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `UPDATE "threads" SET "role" = 'review_agent' WHERE "role" = 'review_lens'`,
    );
    await queryRunner.query(
      `UPDATE "threads" SET "role" = 'review_fix' WHERE "role" = 'post_review'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "messages" DROP CONSTRAINT "fk_messages_subagent_id_subagents"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "steps" ADD CONSTRAINT "fk_steps_job_id_jobs" FOREIGN KEY ("job_id") REFERENCES "jobs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps" ADD CONSTRAINT "fk_steps_org_id_organizations" FOREIGN KEY ("org_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
