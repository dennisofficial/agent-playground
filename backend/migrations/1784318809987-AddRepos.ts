...
export class AddRepos1784318809987 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."repos_default_auto_merge_method_enum" AS ENUM('merge', 'squash', 'rebase')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_repos_org_id_slug" ON "repos" ("org_id", "slug") `);
