...
export class RenameSectionPhaseToTrackStep1782588041115 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tracks" RENAME CONSTRAINT "fk_sections_org_id_organizations" TO "fk_tracks_org_id_organizations"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tracks" RENAME CONSTRAINT "fk_sections_thread_id_threads" TO "fk_tracks_thread_id_threads"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "steps" RENAME CONSTRAINT "fk_phases_org_id_organizations" TO "fk_steps_org_id_organizations"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps" RENAME CONSTRAINT "fk_phases_section_id_sections" TO "fk_steps_track_id_tracks"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "steps" RENAME CONSTRAINT "fk_steps_track_id_tracks" TO "fk_phases_section_id_sections"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps" RENAME CONSTRAINT "fk_steps_org_id_organizations" TO "fk_phases_org_id_organizations"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tracks" RENAME CONSTRAINT "fk_tracks_thread_id_threads" TO "fk_sections_thread_id_threads"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tracks" RENAME CONSTRAINT "fk_tracks_org_id_organizations" TO "fk_sections_org_id_organizations"`,
    );
    await queryRunner.query(
