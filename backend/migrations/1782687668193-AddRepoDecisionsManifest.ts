...
export class AddRepoDecisionsManifest1782687668193 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "repo_decisions" DROP CONSTRAINT "fk_repo_decisions_repo_id_repos"`);
        await queryRunner.query(`ALTER TABLE "repo_decisions" DROP CONSTRAINT "fk_repo_decisions_org_id_organizations"`);
