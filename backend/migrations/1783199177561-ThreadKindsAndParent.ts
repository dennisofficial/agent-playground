...
export class ThreadKindsAndParent1783199177561 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_threads_parent_thread_id" ON "threads" ("parent_thread_id") `);
        await queryRunner.query(`ALTER TABLE "threads" ADD CONSTRAINT "fk_threads_parent_thread_id_threads" FOREIGN KEY ("parent_thread_id") REFERENCES "threads"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "threads" DROP CONSTRAINT "fk_threads_parent_thread_id_threads"`);
        ...
        await queryRunner.query(`ALTER TABLE "threads" ADD CONSTRAINT "uq_threads_job_id_ordinal" UNIQUE ("job_id", "ordinal")`);
    }
