...
export class AddLegRotation1783369653646 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "steps" ADD "rotating_session_id" text`,
    );
    await queryRunner.query(`ALTER TABLE "steps" ADD "pending_leg_seed" text`);
    await queryRunner.query(
      `ALTER TABLE "steps" ADD "leg_ordinal" integer NOT NULL DEFAULT '1'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "build_legs" DROP CONSTRAINT "fk_build_legs_job_id_jobs"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "steps" DROP COLUMN "pending_leg_seed"`,
    );
    await queryRunner.query(
      `ALTER TABLE "steps" DROP COLUMN "rotating_session_id"`,
    );
