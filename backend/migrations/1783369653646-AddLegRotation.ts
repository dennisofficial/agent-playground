...
export class AddLegRotation1783369653646 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "build_legs" DROP CONSTRAINT "fk_build_legs_thread_id_threads"`);
        await queryRunner.query(`ALTER TABLE "build_legs" DROP CONSTRAINT "fk_build_legs_job_id_jobs"`);
        await queryRunner.query(`ALTER TABLE "build_legs" DROP CONSTRAINT "fk_build_legs_org_id_organizations"`);
