...
export class AddJobAutoApprove1783810998038 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "jobs" ADD CONSTRAINT "fk_jobs_auto_approve_by_users" FOREIGN KEY ("auto_approve_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "jobs" DROP CONSTRAINT "fk_jobs_auto_approve_by_users"`);
