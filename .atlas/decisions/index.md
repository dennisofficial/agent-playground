...
| id | decision | status |
|----|----------|--------|
| [agent-html-rendered-in-sandboxed-iframe](agent-html-rendered-in-sandboxed-iframe.md) | Agent-authored HTML renders in a strict opaque-origin sandbox (self-contained only) | proposed |
...
_Last regenerated: 2026-07-09T01:12:51.779Z_
