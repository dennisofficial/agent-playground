...
const { NoticeStack } = await import('../../components/notice-stack')
...
describe('copy on select', () => {
  it('puts a finished selection on the clipboard and says so above the composer', async () => {
